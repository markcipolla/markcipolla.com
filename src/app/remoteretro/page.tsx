      ...
      <Section>
        ...
        <Block columns={3}>
          ...
          <p>
            ...
            sprint/iteration&lsquo;s retro items. 
          </p> 
          <p>
          ...
          <p>
            It&lsquo;s got a bunch of common formats, plus you can customise them. It&lsquo;s got timers, so you can guide your team to add their items, or to vote on ones important to the team.
          </p>
        </Block>
      </Section>
    </>
